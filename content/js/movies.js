"use strict";
const timeout = 0.25;
function getRandomMovie(id, button) {
    ...
    const moviesToWatch = collectMovies(id);
...
function collectMovies(id) {
    ...
    const headingContent = ((_a = heading.nextElementSibling) === null || _a === void 0 ? void 0 : _a.nextElementSibling)
        .innerText;
