...
<section class="photo-workflow" aria-labelledby="workflow-heading">
<h2 id="workflow-heading">publish workflow</h2>
<ol>
<li>keep unprocessed originals out of the site tree in <code>private/photography/originals</code>.</li>
<li>edit the selected scans in Lightroom.</li>
<li>run the Rust build-tool command to strip metadata and create protected exports.</li>
<li>review the generated gallery in the local Quartz server before publishing.</li>
</ol>
</section>
