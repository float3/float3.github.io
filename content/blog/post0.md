...
i.e. <math xmlns="http://www.w3.org/1998/Math/MathML" display="block" class="tml-display" style="display:inline-block;"><semantics><mrow><mrow><mo fence="true" form="prefix">{</mo><mfrac><mn>4</mn><mn>3</mn></mfrac><mo>×</mo><msup><mn>2</mn><mi>n</mi></msup><mo fence="false" stretchy="true" symmetric="true" minsize="2.4em" maxsize="2.4em">|</mo><mi>n</mi><mo>∈</mo><mi>ℕ</mi><mo fence="true" form="postfix">}</mo></mrow><mo>∉</mo><mi>ℚ</mi><mi>\\</mi><mi>ℤ</mi></mrow><annotation encoding="application/x-tex">\left\{ \frac{4}{3} \times 2^n \bigg| n \in \mathbb{N} \right\} \not \in \mathbb{Q}\backslash \mathbb{Z}
